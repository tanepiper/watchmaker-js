...
import { NormalizedBundleBuilderOptions, normalizePackageOptions } from '../../utils/normalize';
...
export default function run(rawOptions: PackageBuilderOptions, context: ExecutorContext) {
