...
import { AssetGlobPattern, BuildBuilderOptions, PackageBuilderOptions, WebBuildBuilderOptions } from './types';
...
export function normalizeWebBuildOptions(
  ...
  return {
    ...
    es2015Polyfills: options.es2015Polyfills ? resolve(root, options.es2015Polyfills) : undefined,
  };
}
